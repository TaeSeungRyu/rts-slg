...
| 24 | 동양풍 용 | `EasternDragon` | `eastern_dragon` | 육지 | **0** | 2 | 1 / 1 / 1 | O | O | O | 동양풍 용 — **타일 3개 차지**, 항상 1마리. 신룡 느낌: 초록 뱀 몸이 S자로 깔리고 머리가 솟는다. 사슴뿔·긴 수염·붉은 눈·등갈기. 몸 마디가 상하로 천천히 물결(정지 유닛의 상시 모션), 공격은 머리를 젖혔다 내밀며 화염(2026-08-07 확정) |
