...
| 22 | 호랑이 | `Tiger` | `tiger` | 육지 | 3 | 2 | 1 / 1 / 1 | O | O | O | 호랑이 — 주황 털에 검은 줄무늬(옆구리 4·등마루·뺨), 흰 주둥이·가슴·발, 두 마디 꼬리. 이동은 기병 갤럽 재사용, 공격은 웅크렸다 몸을 날려 덮치기(2026-08-07 확정) |
