...
| 4 | 벽력거 | `ThunderCart` | `thunder_cart` | 육지 | 2 | 벽력거를 끌고 있다. `Catapult`와 외형·전투 수치가 다르다 |
| 5 | 투석기 | `Catapult` | `catapult` | 육지 | 2 | 투석기를 끌고 있다. `ThunderCart`와 외형·전투 수치가 다르다 |
| 6 | 공성탑 | `SiegeTower` | `siege_tower` | 육지 | 2 | 바퀴 달린 탑을 끌고 있다 |
| 7 | 상병 | `WarElephant` | `war_elephant` | 육지 | 3 | 코끼리를 끌고 있다 |
| 8 | 소선 | `SmallBoat` | `small_boat` | 대하 | 4 | 중국식 작은 배 |
...
| 14 | 산악병 | `Axeman` | `axeman` | 육지+산악 | 3 / 산악 1 | 도끼와 방패를 들고 있다 |
