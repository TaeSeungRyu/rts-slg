    ...
    float FogDensity)
{
    public static readonly IReadOnlyDictionary<string, TonePreset> All = new Dictionary<string, TonePreset>
    {
        ...
        // 안개 0(완전 제거) + 대비 복원 — 뿌연 헤이즈 없이 저채도만으로 담백함을 낸다.
        ["inkwash"] = new(
            new Color(0.72f, 0.75f, 0.78f), new Color(0.88f, 0.88f, 0.86f), new Color(0.50f, 0.52f, 0.55f),
            Ambient: 0.75f, Exposure: 1.0f, Brightness: 1.04f, Contrast: 1.0f, Saturation: 0.5f,
            SunEnergy: 1.1f, SunColor: new Color(0.98f, 0.97f, 0.95f), Vignette: 0.3f, FogDensity: 0f),
    };
