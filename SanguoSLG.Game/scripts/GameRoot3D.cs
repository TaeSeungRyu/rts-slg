...
public partial class GameRoot3D : Node3D
{
    ...
    private void BuildEffectTest()
    {
        ...
        var bands = new[] { (EffectKind.Fire, "Fire"), (EffectKind.Haze, "Haze"), (EffectKind.Flies, "Flies"), (EffectKind.Flood, "Flood"), (EffectKind.Skulls, "Skulls"), (EffectKind.Daze, "Daze"), (EffectKind.Bubbles, "Bubbles"), (EffectKind.Burst, "Burst"), (EffectKind.Tear, "Tear") };
