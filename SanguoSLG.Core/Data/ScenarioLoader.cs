...
public sealed class ScenarioLoader
{
        ...
        string mapJson, string postingsJson = "[]")
    {
        ...
        var balance = new BalanceConfig(balanceDto.MonthlyTaxPerCity, balanceDto.MultiTargetSecondaryPercent,
            ...
            RewardGoldCost: balanceDto.RewardGoldCost, RewardLoyaltyGain: balanceDto.RewardLoyaltyGain);
    ...
    private static FeatureType ParseFeature(string name) => name switch
    {
        ...
        "port_medium" => FeatureType.PortMedium,
    ...
    private static TerrainType ParseTerrain(string name) => name switch
    {
        ...
        "village_2" => TerrainType.Village2,
